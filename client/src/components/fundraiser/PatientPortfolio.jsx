    ...
    <section id="patient-profile" className="py-12 max-w-7xl mx-auto px-4 sm:px-8 border-t border-neutral-200">
      <div className="space-y-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          ...
          <div className="p-6 rounded-3xl bg-white border border-neutral-300 shadow-xs space-y-4 hover:border-black transition-colors">
            <div className="flex items-center gap-3">
              <div className="h-12 w-12 rounded-2xl bg-neutral-100 text-black border border-neutral-300 flex items-center justify-center">
        ...
        {activeTab === 'family' && (
          <div className="p-6 sm:p-10 rounded-3xl bg-white border border-neutral-300 shadow-xs space-y-6">
            ...
            <div className="flex justify-center pt-2">
              <a
                href="#donate"
                className="px-6 py-3 rounded-2xl bg-black text-white hover:bg-neutral-800 text-xs font-bold transition-all shadow-md flex items-center gap-2 cursor-pointer"
              >
